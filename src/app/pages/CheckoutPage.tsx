  ...
  if (orderId) {
    return (
      <section className="rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 p-10 text-center animate-fade-in">
        <div className="mx-auto h-16 w-16 rounded-full bg-slate-100 dark:bg-slate-900/40 flex items-center justify-center">
          <CheckCircle2 className="text-slate-600 dark:text-slate-400" size={34} />
        </div>
        ...
        {completedOrder?.paymentMethod === 'pix' && (
          <div className="mt-4 rounded-xl border border-slate-200 dark:border-slate-900 bg-slate-50 dark:bg-slate-950/30 p-4 text-left max-w-2xl mx-auto">
            <p className="text-sm font-semibold text-slate-700 dark:text-slate-300">
              Pedido PIX: envio no WhatsApp
            </p>
            <p className="mt-1 text-xs text-slate-700/90 dark:text-slate-300/90">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              <a
                ...
                className="inline-flex items-center justify-center rounded-xl bg-black hover:bg-slate-800 text-white dark:bg-white dark:text-black dark:hover:bg-slate-200 px-4 py-2.5 text-sm font-semibold transition-colors"
              >
                Enviar mensagem no WhatsApp
              </a>
              {pixWhatsAppBlocked && (
                <p className="text-xs text-slate-700 dark:text-slate-300 self-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-3">
          <Link
            to={`/pedidos/${orderId}`}
            className="bg-black hover:bg-slate-800 text-white dark:bg-white dark:text-black dark:hover:bg-slate-200 px-5 py-3 rounded-xl font-semibold transition-colors"
          >
            Ver pedido
          </Link>
          <Link
              ...
              return (
                <div
                  ...
                  className={`rounded-xl border px-3 py-2 text-sm font-medium transition-colors ${
                    isActive
                      ? 'border-slate-600 bg-slate-50 dark:bg-slate-950/40 text-slate-700 dark:text-slate-300'
                      : isDone
                      ? 'border-slate-300 dark:border-slate-700 bg-slate-50 dark:bg-slate-950/30 text-slate-700 dark:text-slate-300'
            ...
            <div className="space-y-5">
              <div>
                ...
                <div className="mt-3 grid gap-2">
                  ...
                  <label className="rounded-xl border border-slate-300 dark:border-slate-700 p-3 flex items-center gap-3 cursor-pointer">
                    ...
                    />
                    <CreditCard className="text-slate-600" size={18} />
                    <span className="text-sm font-medium text-slate-700 dark:text-slate-200">
                      Cartao de credito
                    </span>
                  </label>
              ...
              {paymentMethod === 'pix' ? (
                <div className="rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950/30 p-4">
                  ...
                  <p className="text-sm text-slate-700/90 dark:text-slate-300/90 mt-1">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            ...
            {currentStep < 3 ? (
              <button
                type="button"
                onClick={goNext}
                className="bg-black hover:bg-slate-800 text-white dark:bg-white dark:text-black dark:hover:bg-slate-200 font-semibold py-3 px-5 rounded-xl transition-colors"
              >
                Continuar
              </button>
            ) : (
              <button
                ...
                className="bg-black hover:bg-slate-800 disabled:bg-slate-400 text-white dark:bg-white dark:text-black dark:hover:bg-slate-200 dark:disabled:bg-slate-600 dark:disabled:text-slate-300 font-semibold py-3 px-5 rounded-xl transition-colors"
              >
            ...
            <div>
              ...
              <div className="mt-2 flex gap-2">
                ...
                <button
                  ...
                  className="rounded-xl bg-black hover:bg-slate-800 disabled:bg-slate-400 text-white dark:bg-white dark:text-black dark:hover:bg-slate-200 dark:disabled:bg-slate-600 dark:disabled:text-slate-300 px-4 py-2.5 text-sm font-semibold transition-colors"
                >
                  {isApplyingCoupon ? 'Aplicando...' : 'Aplicar'}
                </button>
              </div>
              {appliedCoupon && (
                <div className="mt-2 flex items-center justify-between gap-3 rounded-xl border border-slate-200 dark:border-slate-900 bg-slate-50 dark:bg-slate-950/20 px-3 py-2">
                  <div className="min-w-0">
                    <p className="text-sm font-semibold text-slate-800 dark:text-slate-200 truncate">
                      {appliedCoupon.code} (-{appliedCoupon.discountPercentage}%)
                    </p>
                    {appliedCoupon.description && (
                      <p className="text-xs text-slate-800/80 dark:text-slate-200/80 line-clamp-1">
                        {appliedCoupon.description}
                      </p>
                    )}
                  </div>
                  <button
                    ...
                    className="rounded-lg border border-slate-200 dark:border-slate-900 px-2.5 py-1.5 text-xs font-semibold text-slate-800 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-950/30 transition-colors"
                  >
                    Remover
                  </button>
                </div>
