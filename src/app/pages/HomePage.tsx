...
const HomePage = ({ onProductClick }: HomePageProps) => {
  ...
  return (
    <div className="space-y-16">
      <section className="section-reveal -mt-8 md:-mt-10 relative w-screen ml-[calc(50%-50vw)] overflow-hidden border-y border-slate-200 dark:border-slate-800">
        <img
          src={campaignImage}
          alt="Campanha Nuvle"
        ...
        <div className="relative z-10 mx-auto max-w-[1440px] grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end px-4 py-10 sm:px-6 sm:py-14 lg:px-10 lg:py-16 min-h-[72vh] sm:min-h-[78vh] lg:min-h-[86vh]">
          ...
          <div className="rounded-xl border border-slate-300 dark:border-slate-700 bg-white/90 dark:bg-black/65 backdrop-blur px-4 sm:px-5 py-4 flex items-center gap-3 self-end max-w-xl">
            <img
            ...
            <div className="min-w-0">
              <p className="text-[11px] uppercase tracking-[0.18em] text-slate-600 dark:text-slate-300">Destaque da semana</p>
            ...
            {categoryRows.map(({ title, description, query, image }) => (
              ...
              >
                ...
                <div className="absolute inset-x-4 bottom-4 flex items-end justify-between gap-4">
                  ...
                  <span className="rounded-md border border-slate-200/40 bg-black/75 px-3 py-1 text-xs font-semibold text-white dark:bg-white dark:text-black">
                    Explorar
                  </span>
                </div>
              </Link>
      ...
      <section className="section-reveal stagger-2">
        <div className="flex items-end justify-between mb-6">
          <div>
            <p className="inline-flex items-center gap-2 rounded-md border border-slate-300 dark:border-slate-700 bg-slate-100 dark:bg-slate-900 px-3 py-1 text-[11px] uppercase tracking-[0.16em] font-semibold text-slate-700 dark:text-slate-200">
              Em alta
            </p>
          ...
          <Link
            to="/produtos"
            className="hidden md:inline-flex text-slate-800 dark:text-slate-100 font-semibold hover:text-black dark:hover:text-white"
          >
      ...
      <section className="section-reveal stagger-3 rounded-md border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-950 text-slate-900 dark:text-slate-100 p-8 md:p-10">
        <div className="grid gap-8 lg:grid-cols-2 lg:items-center">
          ...
          <div className="flex flex-wrap gap-3 lg:justify-end">
            <a
              ...
              className="inline-flex items-center justify-center bg-black hover:bg-slate-900 text-white dark:bg-white dark:text-black dark:hover:bg-slate-200 font-semibold px-5 py-3 rounded-md transition-colors"
            >
              Abrir canais oficiais
            </a>
            <Link
              to="/login"
              className="inline-flex items-center justify-center border border-slate-300 dark:border-slate-700 hover:bg-slate-100 dark:hover:bg-slate-900 text-slate-800 dark:text-slate-100 font-semibold px-5 py-3 rounded-md transition-colors"
            >
              Entrar na conta
            </Link>
          </div>
