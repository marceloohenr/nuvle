...
const rawProducts: Array<Omit<Product, 'stock'>> = [
  // Camisetas Oversized
  {
    ...
    category: 'oversized',
    description: 'Camiseta oversized branca com modelagem ampla e confortavel',
    sizes: ['P', 'M', 'G', 'GG'],
  },
  {
    id: 'oversized-preta',
    ...
    category: 'oversized',
    description: 'Camiseta oversized preta com modelagem ampla e confortavel',
    sizes: ['P', 'M', 'G', 'GG'],
  },
  {
    id: 'oversized-cinza',
    ...
    category: 'oversized',
    description: 'Camiseta oversized cinza com modelagem ampla e confortavel',
    sizes: ['P', 'M', 'G', 'GG'],
  },
  {
    id: 'oversized-verde',
    ...
    category: 'oversized',
    description: 'Camiseta oversized verde com modelagem ampla e confortavel',
    sizes: ['P', 'M', 'G', 'GG'],
  },
  // Camisetas Basicas
  {
    id: 'logo-basica-branca',
    name: 'Logo Basica Branca',
    price: 74.9,
    originalPrice: 100.0,
    image: 'https://i.postimg.cc/4xfNs6Lm/Imagem-do-Whats-App-de-2025-08-12-s-19-57-03-7485f5d8.jpg',
    category: 'basicas',
    description: 'Camiseta basica com logo da marca em alta qualidade',
    sizes: ['P', 'M', 'G', 'GG'],
  },
  {
    id: 'basica-preta',
    name: 'Nome Basica Preta',
    price: 74.9,
    originalPrice: 100.0,
    image: 'https://i.postimg.cc/7hf1YFF1/BASICA-1.jpg',
    category: 'basicas',
    description: 'Camiseta basica preta essencial para o guarda-roupa',
    sizes: ['P', 'M', 'G', 'GG'],
  },
  {
    id: 'basica-branca',
    name: 'Nome Basica Branca',
    price: 74.9,
    originalPrice: 100.0,
    image: 'https://i.postimg.cc/kGzQVjC0/BASICA-2.jpg',
    category: 'basicas',
    description: 'Camiseta basica branca classica e versatil',
    sizes: ['P', 'M', 'G', 'GG'],
  },
  {
    id: 'logo-basica-preta',
    name: 'Logo Basica Preta',
    price: 74.9,
    originalPrice: 100.0,
    image: 'https://i.postimg.cc/SNpxtFcL/Imagem-do-Whats-App-de-2025-08-12-s-19-57-03-34020ff4.jpg',
    category: 'basicas',
    description: 'Camiseta basica preta com logo da marca',
    sizes: ['P', 'M', 'G', 'GG'],
  },
  ...
  },
  {
    ...
    category: 'estampadas',
    description: 'Camiseta com estampa artistica Blue Fox',
    sizes: ['P', 'M', 'G', 'GG'],
  },
  {
    id: 'pink-panther',
  ...
  },
  {
    ...
    category: 'estampadas',
    description: 'Camiseta classica com estampa Good Eagle',
    sizes: ['P', 'M', 'G', 'GG'],
  },
  {
    id: 'school-rabbit',
  ...
  },
  {
    ...
    category: 'estampadas',
    description: 'Camiseta unica com estampa Millionaire Duck',
    sizes: ['P', 'M', 'G', 'GG'],
  },
  {
    id: 'blue-alien',
    ...
    category: 'estampadas',
    description: 'Camiseta futuristica com estampa Blue Alien',
    sizes: ['P', 'M', 'G', 'GG'],
  },
];
